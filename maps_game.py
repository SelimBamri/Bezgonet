...
def map_game(function, function2):
    questions = function2()
    ...
    def game():
        ...
        def gameplay(i):
            ...
            global map_image, option_1_image, option_2_image, option_3_image, option_4_image
            map_image = PhotoImage(file=questions[i]["map"])
            ...
            canvas.create_image(500, 540, image=map_image)
