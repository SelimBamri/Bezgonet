...
def capital_game(function, function2):
    questions = function2()
    ...
    def game():
        ...
        def gameplay(i):
            ...
            global name_image, flag_image, option_1_image, option_2_image, option_3_image, option_4_image
            name_image = PhotoImage(file=questions[i]["name"])
            flag_image = PhotoImage(file=questions[i]["flag"])
            option_1_image = PhotoImage(file=questions[i]["option_1"].capital)
            option_2_image = PhotoImage(file=questions[i]["option_2"].capital)
            option_3_image = PhotoImage(file=questions[i]["option_3"].capital)
            option_4_image = PhotoImage(file=questions[i]["option_4"].capital)
            ...
            canvas.create_image(500, 200, image=name_image)
